...
const categories = [
  { image: "/images/puresilk1.webp", label: "Exclusive Wedding Pure Silk Sarees" },
  { image: "/images/puresilk2.webp", label: "Traditional Pure Silk Sarees" },
  { image: "/images/puresilk3.webp", label: "Designer Pure Silk Sarees" },
  { image: "/images/puresilk4.webp", label: "Fancy Pure Silk Sarees" },
];
...
const TopCategories = () => {
  ...
  return (
    <>
    <div id="products" className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-10 py-12 sm:py-16 lg:py-20">
